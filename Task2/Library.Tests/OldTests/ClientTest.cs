...
namespace Tests
{
    ...
    public class ClientTest
    {
        ...
        public void Initialize()
        {
            ...
            repository.AddClient(new Client(1, "Bartlomiej", "Wlodarski", 20));
            repository.AddClient(new Client(2, "Maciej", "Wlodarczyk", 21));
            repository.AddClient(new Client(3, "Jan", "Kowalski", 40));
        }
        [TestMethod]
        public void DataRepositoryAddClientTest()
        {
            ...
            repository.AddClient(new Client(4, "Mateusz", "Owczarek", 22));
            repository.AddClient(new Client(5, "Maciej", "Kopa", 16));
            repository.AddClient(new Client(6, "Monika", "Roksa", 23));
        ...
        {
            repository.AddClient(new Client(4, "Marek", "Mostowiak", 45));
        ...
        {
            repository.EditClient(new Client(1, "Bartlomiej", "Wlodarczyk", 21));
        ...
        {
            List<Client> catalog = repository.GetClientCatalog();
