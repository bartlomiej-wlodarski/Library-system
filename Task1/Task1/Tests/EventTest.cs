...
namespace Tests
{
    ...
    public class EventTest
    {
        ...
        public void Initialize()
        {
            ...
            repository.AddEvent(new Data.RentEvent(1, new Data.Client(1, "Bartlomiej", "Wlodarski", 20), date_1, repository.GetState()));
            repository.AddEvent(new Data.RentEvent(2, new Data.Client(2, "Maciej", "Wlodarczyk", 21), date_2, repository.GetState()));
            repository.AddEvent(new Data.ReturnEvent(3, new Data.Client(3, "Jan", "Kowalski", 40), date_3, repository.GetState()));
        }
        ...
        public void DataRepositoryAddEventTest()
        {
            ...
            repository.AddEvent(new Data.RentEvent(4, new Data.Client(4, "Monika", "Roksa", 23), date_1, repository.GetState()));
            repository.AddEvent(new Data.RentEvent(5, new Data.Client(5, "Anna", "Przystanska", 34), date_3, repository.GetState()));
        ...
        {
            repository.EditEvent(new Data.RentEvent(1, new Data.Client(1, "Bartosz", "Wlodarczyk", 25), date_2, repository.GetState()));
            ...
            repository.EditEvent(new Data.RentEvent(2, new Data.Client(2, "Marco", "Murinho", 37), date_1, repository.GetState()));
